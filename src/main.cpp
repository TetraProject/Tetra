...
#if defined(NDEBUG)
# error "Tetra cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x92aa7047e48adb0a447cbee533cf8dbba146c35d057c881e40c48482871d28e9");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Tetra: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Tetra Signed Message:\n";
...
{
    // Tetra: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    int64 nSubsidy = 0.03 * COIN;

    if(nHeight == 1)  
        nSubsidy = 163000 * COIN;
    
    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 5 * 60; // Tetra: 5 minutes
static const int64 nTargetSpacing = 2 * 60; // Tetra: 2 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Tetra: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Tetra: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x92aa7047e48adb0a447cbee533cf8dbba146c35d057c881e40c48482871d28e9");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis block
        const char* pszTimestamp = "Tetra 2016/06/05";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("42181710a1589ada023691c80f3a41a8f13f1d45bac157fbcba8bc4a8ea13eb4b10a4d4a041a08dce60aaaf0fa1021afe1b51850a2acf21ba79c45070aa7b13a8") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1465159238;
		...
		//CBlock(
		//hash=92aa7047e48adb0a447cbee533cf8dbba146c35d057c881e40c48482871d28e9, 
		//hashMerkleRoot=9442d6b310035d77e091544b63369befe0bf68e7ad47d562e2e1cd3bdc14d7df, 
		//nTime=1465159238, 
		//nBits=1e0ffff0, 
		//nNonce=358516)
        ...
        assert(block.hashMerkleRoot == uint256("0x9442d6b310035d77e091544b63369befe0bf68e7ad47d562e2e1cd3bdc14d7df"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x10, 0x2a, 0xc9, 0x3d };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("TetraMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("TetraMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static TetraMiner(CWallet *pwallet)
{
    printf("TetraMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("tetra-miner");
    ...
    try { loop {
        ...
        printf("Running TetraMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&TetraMiner, pwallet));
}
